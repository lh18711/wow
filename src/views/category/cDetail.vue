<template>
  <div class="main">
    ...
    <div class="categorySwiper"
         v-if="categoryData[$route.params.type]&&categoryData[$route.params.type].list.length">
...
export default {
  ...
  updated () {
    if (this.categoryData[this.$route.params.type] && this.categoryData[this.$route.params.type].list.length) {
      this.init()
    }
  },
  methods: {
